package com.rison.realtime.bean;
...
public class PaymentWide {
    ...
    public PaymentWide(com.atguigu.bean.PaymentInfo paymentInfo, com.atguigu.bean.OrderWide orderWide) {
        mergeOrderWide(orderWide);
        mergePaymentInfo(paymentInfo);
    }

    public void mergePaymentInfo(com.atguigu.bean.PaymentInfo paymentInfo) {
        if (paymentInfo != null) {
            try {
    ...
    public void mergeOrderWide(com.atguigu.bean.OrderWide orderWide) {
        if (orderWide != null) {
            try {
