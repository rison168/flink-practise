...
public class OrderWide {
    ...
    public OrderWide(com.atguigu.bean.OrderInfo orderInfo, com.atguigu.bean.OrderDetail orderDetail) {
        mergeOrderInfo(orderInfo);
        mergeOrderDetail(orderDetail);
    }

    public void mergeOrderInfo(com.atguigu.bean.OrderInfo orderInfo) {
        if (orderInfo != null) {
    ...
    public void mergeOrderDetail(com.atguigu.bean.OrderDetail orderDetail) {
        if (orderDetail != null) {
